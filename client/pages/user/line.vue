<template>
	<view class="qiun-columns">
		...
		<view class="qiun-bg-white qiun-padding"><text>pages/basic/line/line</text></view>
		<!--#endif-->
		...
		<view class="qiun-common-mt" style="font-size:14px;text-align: center;">请在图表上左右移动</view>
		<!--#ifdef H5 -->
